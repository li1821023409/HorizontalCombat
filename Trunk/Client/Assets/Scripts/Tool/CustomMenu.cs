...
namespace WNGameTool
{
    public class CustomMenu
    {
        ...
        [MenuItem("Tools/创建InventoryDictionary")]
        ...
        [MenuItem("Tools/CSV文件生成对应FileData类")]
        ...
        [MenuItem("Tools/所有CSV文件生成对应FileData类")]
